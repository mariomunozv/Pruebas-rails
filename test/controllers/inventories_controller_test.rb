...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { details: @inventory.details, store_id: @inventory.store_id, user_id: @inventory.user_id }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { details: @inventory.details, store_id: @inventory.store_id, user_id: @inventory.user_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
