...
class CashboxesControllerTest < ActionController::TestCase
  ...
  test "should create cashbox" do
    assert_difference('Cashbox.count') do
      post :create, cashbox: { description: @cashbox.description, name: @cashbox.name, store_id: @cashbox.store_id }
    end
  ...
  test "should update cashbox" do
    patch :update, id: @cashbox, cashbox: { description: @cashbox.description, name: @cashbox.name, store_id: @cashbox.store_id }
    assert_redirected_to cashbox_path(assigns(:cashbox))
  end
